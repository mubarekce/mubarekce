...
const EsmaulHusna: React.FC<{ onBack: () => void }> = ({ onBack }) => {
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-gradient-to-b from-white via-[#fbf6ea] to-[#f5ead0] dark:from-[#3e5878] dark:via-[#243a58] dark:to-[#141a2c] animate-in fade-in slide-in-from-right duration-300 overflow-hidden relative">
      {/* Header */}
      <div className="px-6 pt-12 pb-6 flex items-center gap-5 bg-[#fbf6ea]/80 dark:bg-[#141a2c]/80 backdrop-blur-md sticky top-0 z-30 border-b border-slate-50/50">
      ...
      <div className="flex-1 overflow-y-auto px-6 pb-36 space-y-5 no-scrollbar">
        {filtered.map((esma) => (
          ...
          >
            ...
            <div className="mt-8">
               <div className="inline-flex items-center gap-3 bg-[#fbf6ea]/80 dark:bg-[#141a2c]/80 border border-purple-50 px-6 py-3 rounded-[1.4rem] shadow-sm group-hover:bg-purple-50/50 group-hover:border-purple-200 transition-colors">
      ...
      {activeDhikrId && activeEsma && (
        <div className="fixed inset-0 z-[400] bg-gradient-to-b from-white via-[#fbf6ea] to-[#f5ead0] dark:from-[#3e5878] dark:via-[#243a58] dark:to-[#141a2c] flex flex-col items-center animate-in slide-in-from-bottom duration-500">
