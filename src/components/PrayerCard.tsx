  ...
  return (
    <div className={`group relative px-6 py-5 rounded-[2.2rem] flex items-center justify-between transition-all duration-500 border cursor-pointer ${
      ...
      <div className="flex items-center gap-6">
        ...
        <div>
          <p className={`text-[9px] font-black uppercase tracking-[0.25em] mb-1 ${isActive ? 'text-gold-600' : 'text-slate-300 dark:text-slate-600'}`}>
            {name}
          </p>
      ...
      {isActive ? (
        <div className="flex flex-col items-end gap-1">
          <span className="px-3 py-1 bg-gold-600 text-white rounded-full text-[8px] font-black uppercase tracking-widest shadow-md">Aktif</span>
