  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-b from-white via-[#fbf6ea] to-[#f5ead0] dark:from-[#3e5878] dark:via-[#243a58] dark:to-[#141a2c] flex flex-col justify-center items-center p-8 relative overflow-hidden transition-colors duration-300">
      ...
      <div className="w-full max-w-[420px] z-10">
        ...
        {/* Form Card */}
        <div className="bg-gradient-to-b from-white via-[#fbf6ea] to-[#f5ead0] dark:from-[#3e5878] dark:via-[#243a58] dark:to-[#141a2c] rounded-[2.5rem] p-8 md:p-10 shadow-[0_30px_60px_-12px_rgba(13,18,32,0.15)] border border-gold-100/50 dark:border-navy-800 relative overflow-hidden transition-colors duration-300">
