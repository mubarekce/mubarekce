  ...
  return (
    <div className="min-h-screen w-full bg-white flex flex-col justify-center items-center p-8 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full opacity-5 pointer-events-none">
        ...
        <div className="absolute bottom-[-20%] left-[-20%] w-[80%] aspect-square bg-emerald-200 rounded-full blur-[150px]"></div>
      </div>
      ...
      <div className="w-full max-w-[420px] z-10">
        ...
        <div className="bg-[#f0f9ff] rounded-[2.5rem] p-8 md:p-10 shadow-[0_30px_60px_-12px_rgba(0,163,255,0.1)] border border-sky-100/50 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            {infoMsg && (
              <div className="mb-4 px-4 py-2.5 rounded-xl bg-emerald-50 border border-emerald-100 text-emerald-700 text-[11px] font-bold text-center">
                {infoMsg}
              </div>
            )}
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-1.5">
                <div className="flex items-center justify-between ml-4 mr-1">
                  ...
                  {isLogin && (
                    <button type="button" onClick={handleForgotPassword} className="text-[9px] font-black text-emerald-600 uppercase tracking-widest">
                      Unuttum
                    </button>
                  )}
                </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-emerald-600 hover:bg-emerald-700 disabled:opacity-60 text-white font-black py-3.5 rounded-[1.5rem] shadow-lg shadow-emerald-900/10 active:scale-[0.98] transition-all mt-4 uppercase tracking-[0.2em] text-[11px]"
              >
            ...
            <div className="mt-8 pt-6 border-t border-sky-100 text-center">
              ...
              <div className="flex flex-col gap-2.5">
                ...
                >
                  ...
                  <span className="text-[10px] font-black text-slate-600 group-hover:text-emerald-900 uppercase tracking-widest">Google ile devam et</span>
                </button>
              </div>
            </div>
          </div>
