      ...
      <div className="flex-1 overflow-y-auto px-6 pb-40 no-scrollbar relative z-10 pt-4">
        ...
        {activeTab === 'zikirler' && (
          <div className="space-y-12 animate-in fade-in duration-700 pt-10 flex flex-col items-center">
             ...
             >
                <div className="absolute inset-0 rounded-full bg-indigo-500/5 blur-[40px] opacity-60"></div>
                ...
                <svg viewBox="0 0 320 320" className="absolute inset-0 w-full h-full -rotate-90 pointer-events-none">
                    ...
                    <circle 
                        cx="160" cy="160" r="140" 
                        className="stroke-indigo-600 fill-none transition-all duration-700 ease-out shadow-2xl" 
                        strokeWidth="16"
                        strokeLinecap="round"
                        strokeDasharray={880}
        ...
        {activeTab === 'nefes' && (
          <div className="space-y-12 animate-in fade-in duration-700 pt-10 flex flex-col items-center">
            ...
            <div className="relative w-full max-w-[320px] aspect-square flex items-center justify-center">
                <div className="absolute inset-0 rounded-full bg-indigo-50/50 blur-3xl opacity-50"></div>
                <div 
                    className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full border-[12px] border-indigo-100 transition-all duration-[300ms] ease-linear origin-center"
                    style={{ 
