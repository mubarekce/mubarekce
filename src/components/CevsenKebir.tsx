      ...
      <div className="flex-1 overflow-y-auto px-6 pb-40 no-scrollbar space-y-12 pt-8">
        ...
        <div className="space-y-12 pb-20">
          ...
          <div className="py-12 space-y-8">
             ...
             <div className="bg-emerald-50/40 p-10 rounded-[3.5rem] border border-emerald-100 text-center space-y-8 relative overflow-hidden group">
                ...
                <div className="inline-block px-5 py-2 bg-emerald-100 text-emerald-700 rounded-full text-[10px] font-black uppercase tracking-[0.3em] mb-2 border border-emerald-200">NAKARAT</div>
                <p className="arabic-text text-3xl text-emerald-950 font-bold leading-relaxed bg-transparent" dir="rtl">{REFRAIN.arabic}</p>
                <div className="h-px w-12 bg-emerald-200/50 mx-auto"></div>
                <p className="text-[14px] font-bold text-emerald-800/70 leading-relaxed px-6 italic bg-transparent">
                  "{REFRAIN.translation}"
                </p>
             </div>
          </div>
