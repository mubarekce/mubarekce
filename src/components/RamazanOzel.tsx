    ...
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="bg-white dark:bg-navy-800 rounded-[3rem] p-8 border border-slate-50 dark:border-navy-900 shadow-xl shadow-slate-900/5 space-y-6">
        <div className="flex items-center justify-between mb-2">
          ...
          <span className="text-[10px] font-black text-gold-600 bg-gold-50 dark:bg-navy-950/20 px-3 py-1 rounded-full">{dailyTasks.filter(t => t.completed).length} / {dailyTasks.length}</span>
        </div>
