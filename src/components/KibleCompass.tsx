  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-between py-12 px-8 h-full bg-[#F8FAFC]">
      ...
      <div className="relative w-80 h-80 flex items-center justify-center">
        ...
        {/* Compass Dial */}
        <div 
          className="relative w-72 h-72 bg-white dark:bg-navy-800 rounded-full shadow-2xl border-[12px] border-slate-100 dark:border-navy-900 flex items-center justify-center transition-transform duration-100 ease-out"
        ...
        >
          ...
          {/* Center Indicator */}
          <div className="w-1.5 h-40 bg-slate-100 dark:bg-navy-900 rounded-full relative">
            <div className="absolute top-0 w-3 h-20 bg-rose-500 rounded-t-full -left-0.5 shadow-[0_0_15px_rgba(244,63,94,0.3)]"></div>
            <div className="absolute bottom-1/2 left-1/2 -translate-x-1/2 translate-y-1/2 w-6 h-6 bg-white dark:bg-navy-800 rounded-full border-4 border-slate-900 shadow-xl z-10"></div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full space-y-6">
        <div className={`p-6 rounded-[2rem] border transition-all duration-700 text-center ${
          isTargeted 
            ...
            : 'bg-white dark:bg-navy-800 border-slate-100 dark:border-navy-900 text-slate-400 dark:text-slate-500'
        }`}>
        ...
        <div className="flex justify-between items-center px-4">
           ...
           <div className="h-6 w-px bg-slate-100 dark:bg-navy-900"></div>
           <div className="text-center">
