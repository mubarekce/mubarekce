...
export const SHORTCUT_CATALOG: HomeShortcut[] = [
  ...
  { id: 'quran', label: 'Kuran-ı Kerim', desc: 'Oku & Dinle', emoji: '📖', bg: 'from-teal-50/70 to-white dark:from-teal-950/20 dark:to-[#141a2c]', ring: 'border-teal-100 dark:border-teal-900/30' },
  { id: 'camiler', label: 'Yakın Camiler', desc: 'Mescit Bul', emoji: '🕌', bg: 'from-emerald-50/70 to-white dark:from-emerald-950/20 dark:to-[#141a2c]', ring: 'border-emerald-100 dark:border-emerald-900/30' },
  ...
  { id: 'hatim-org', label: 'Hatim Organizatörü', desc: 'Grup Hatim', emoji: '🤝', bg: 'from-sky-50 to-white dark:from-sky-950/20 dark:to-[#141a2c]', ring: 'border-sky-100 dark:border-sky-900/30' },
  ...
  { id: 'cevsen', label: 'Cevşen-ül Kebir', desc: 'Koruyucu Dua', emoji: '🤲', bg: 'from-indigo-50 to-white dark:from-indigo-950/20 dark:to-[#141a2c]', ring: 'border-indigo-100 dark:border-indigo-900/30' },
  { id: 'sanal-bahce', label: 'Sanal Bahçem', desc: 'İbadet Takibi', emoji: '🌿', bg: 'from-green-50 to-white dark:from-green-950/20 dark:to-[#141a2c]', ring: 'border-green-100 dark:border-green-900/30' },
  ...
  { id: 'abdest', label: 'Namaz Rehberi', desc: 'Sesli Anlatım', emoji: '💧', bg: 'from-sky-50 to-white dark:from-sky-950/20 dark:to-[#141a2c]', ring: 'border-sky-100 dark:border-sky-900/30' },
];
